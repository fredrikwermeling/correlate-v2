...
V2.0 has all features of the original Correlate app, but includes the expression data sets, and allow for "expression correlates" in the Mutation Analysis Inspect window. 
